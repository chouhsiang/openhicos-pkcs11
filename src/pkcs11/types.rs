...
// PKCS#11: CK_ULONG is C `unsigned long` — 64-bit on LP64 (Unix), 32-bit on Windows (LLP64).
#[cfg(windows)]
...
// Windows cryptoki.h uses `#pragma pack(push, cryptoki, 1)`; Unix uses natural alignment.
#[cfg_attr(windows, repr(C, packed(1)))]
